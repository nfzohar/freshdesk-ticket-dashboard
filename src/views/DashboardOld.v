<template>
  ...
  <!-- TO DO: configuration wizard -->
  <!-- create a layout that is a user-defined grid of dashboardPanels, saved to state. -->
  <!-- add option to show tickets and ticket counts sections as rows -->
  <!-- save all to state -->
